...
const tab = ref('photo') // 'photo' | 'info'
...
<template>
  <article class="resource-card">
    <div class="resource-card__media" :style="{ background: resource.cover }">
...
.tab-btn--active { background: var(--c-white); font-weight: 600; }
.resource-card__name {
...
.details-empty { font-size: 13px; color: var(--c-text-muted); }
...
.details-item__time { font-weight: 700; color: var(--c-primary); }
.details-item__title { font-weight: 600; }
.details-item__people { color: var(--c-text-muted); }
