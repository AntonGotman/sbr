...
<template>
  <div class="auth-screen">
    <div class="auth-card">
      <router-link to="/" class="auth-logo">СБР</router-link>
      <h1 class="auth-title">Регистрация</h1>
      <p class="auth-subtitle">Создайте аккаунт сотрудника, чтобы бронировать ресурсы</p>

      <form class="auth-form" @submit.prevent="submit">
        <label class="field">
          <span class="field-label">Имя и фамилия</span>
          <input v-model="name" class="field-input" placeholder="Иван Иванов" required />
        </label>
        <label class="field">
